...
const baseConocimiento = {
  categorias: {
    ...
    gruposAlimenticios: [
      ...
      { palabraClave: ["fibra", "estreñimiento", "digestión", "fibroso"], respuesta: "La **fibra** es crucial para una buena digestión, previene el estreñimiento y te ayuda a sentirte lleno por más tiempo. La encuentras en **frutas** (con cáscara), **verduras**, **cereales integrales**, **legumbres** y **frutos secos**." },
    ...
    dietasPopulares: [
      ...
      { palabraClave: ["mediterránea", "dieta mediterranea"], respuesta: "La **dieta mediterránea** es considerada una de las más saludables: se basa en vegetales, frutas, legumbres, cereales integrales, aceite de oliva, pescado, y consumo moderado de lácteos y aves. Es antiinflamatoria y buena para el corazón." },
